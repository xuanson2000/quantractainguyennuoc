                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h4 class="pull-left mb-0">{{ !empty($category->name) ? $category->name : 'Category' }}</h4>
                                <div class="btn-group  mt-0 mb-0 pull-right" role="group">
                                    <a href="{{ route('categories.category.index') }}" class="btn btn-primary waves-effect waves-light" title="{{ trans('categories.show_all') }}">
                                        <i class="fa fa-list" aria-hidden="true"></i> {{ trans('categories.show_all') }}
                                    </a>
                                    <a href="{{ route('categories.category.create') }}" class="btn btn-success waves-effect waves-light" title="{{ trans('categories.create') }}">
