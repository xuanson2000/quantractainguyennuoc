...
@section('content')
    <div class="easyui-layout map-container">
        ...
        <div class="easyui-panel" data-options="region:'east',split:true" title="East" style="width:180px;">
        </div>
        <div class="easyui-panel" data-options="region:'west',split:true" title="West" style="width:100px;">
            @include('home.maps.listwells')
        </div>
        <div id="map-panel" class="easyui-panel map-container" data-options="region:'center',iconCls:'icon-tip'" title="Center">
            <div id="map"></div>
        </div>
    </div>
