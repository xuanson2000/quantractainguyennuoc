...
@section('content')
    ...
    <script type="text/javascript">
        ...
        const quantracktnddWMSSource = new ol.source.TileWMS({
            url: 'http://123.16.176.41:8088/geoserver/quantrac/wms',
            params: {
                'FORMAT': format,
                'VERSION': '1.1.1',
                tiled: true,
                STYLES: '',
                LAYERS: 'quantrac:hientrangktndd',
                title: "Điểm khai thác nước dưới đất",
                tilesOrigin: 185100.3262864739 + "," + 939575.001675438
            }
        });
        ...
        const gwmapLayers = new ol.layer.Group({
        ...
        const map = new ol.Map({
            controls: controlSet,
            layers: [basedLayers, hanhchinhLayers, gwmapLayers],
            target: 'map',
            view: view
        });
        ...
        map.on('singleclick', function (evt) {
            const layList = [diaphantinhWMSSource, diaphanhuyenWMSSource, diaphanxaWMSSource, quantracktnddWMSSource, riverBasinWMSSource ];
