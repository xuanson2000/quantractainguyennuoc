...
@section('content')
    ...
    <script type="text/javascript">
        ...
        const qp3WMSSource = new ol.source.TileWMS({
            url: 'http://123.16.176.41:8088/geoserver/nuocduoidat/wms',
            params: {
                'FORMAT': format,
                'VERSION': '1.1.1',
                tiled: true,
                STYLES: '',
                LAYERS: 'nuocduoidat:tcn_qp3_3857',
        ...
        map.on('singleclick', function (evt) {
            const layList = [diaphanxaWMSSource, diaphanhuyenWMSSource, diaphantinhWMSSource, dongmucWMSSource, diachatWMSSource, dutgayWMSSource, qp3WMSSource, songmotnetWMSSource, songvungWMSSource];
