...
@section('global_js')
    <script type="text/javascript">
        ...
        var swReportAjaxByNetworkUri = "{{ route('articles.article.ajax_network_swreport_sidebar')}}";
        var swReportAjaxByBasinUri = "{{ route('articles.article.ajax_basin_swreport_sidebar')}}";
...
@section('content')
    ...
    <div class="easyui-layout map-container">
        ...
        <div class="easyui-panel" data-options="region:'east',split:true,hideCollapsedContent:false,collapsed:true" title="Lớp/Chú giải bản đồ" style="width:300px;">
        </div>
        ...
        <div class="easyui-panel map-container" data-options="region:'center'">
            <div class="easyui-layout" data-options="fit:true">
                <div id="filtered-objs" data-options="region:'west',split:true,hideCollapsedContent:false" title="Công trình/Bản tin" style="width:500px"></div>
    ...
    <script type="text/javascript">
        function showSWreportListByBasin(basin_id) {
            $.ajax({
                type: 'GET',
                url: swReportAjaxByBasinUri,
        ...
        function showSWreportListByNetwork(network_id) {
            $.ajax({
                type: 'GET',
                url: swReportAjaxByNetworkUri,
        ...
        function showSWstationListByBasin(basin_id) {
        ...
        function showSWstationListByNetwork(network_id) {
    ...
    <script type="text/javascript">
        ...
        map.on('singleclick', function (evt) {
            ...
            const url = swStationWMSSource.getGetFeatureInfoUrl(
