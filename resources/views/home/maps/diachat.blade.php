...
@section('content')
    ...
    <script type="text/javascript">
        ...
        map.on('singleclick', function (evt) {
            const layList = [diaphanxaWMSSource, diaphanhuyenWMSSource, diaphantinhWMSSource, dongmucWMSSource, diachatWMSSource, dutgayWMSSource, songmotnetWMSSource, songvungWMSSource];
