...
@section('content')
    ...
    <script type="text/javascript">
        ...
        const monitoringNetworkWMSSource = new ol.source.TileWMS({
            url: 'http://123.16.176.41:8088/geoserver/quantrac/wms',
            params: {
                'FORMAT': format,
                'VERSION': '1.1.1',
        ...
        const swmapLayers = new ol.layer.Group({
            ...
            layers: [
                ...
                new ol.layer.Tile({
                    title: "Điểm dự báo nước mặt",
                    source: swForecastingPointsWMSSource
                }),
                new ol.layer.Tile({
                    title: "Mạng quan trắc",
                    source: monitoringNetworkWMSSource
                }),
                new ol.layer.Tile({
                    title: "Lưu vực sông",
        ...
        map.on('singleclick', function (evt) {
            const layList = [diaphantinhWMSSource, diaphanhuyenWMSSource, diaphanxaWMSSource, swStationWMSSource, swForecastingPointsWMSSource, monitoringNetworkWMSSource, riverBasinWMSSource ];
